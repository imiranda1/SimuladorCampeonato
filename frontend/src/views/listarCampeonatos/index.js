            ...
            <table class="table table-striped">
                ...
                <tbody>
                    {campeonatos.map(campeonato => (
                        <tr>
                            <th scope="row">{campeonato.camp_id}</th>
                            <td>{campeonato.camp_nome}</td>
                            <td>{campeonato.camp_patrocinador}</td>
                            <td>{campeonato.camp_quantidade_times}</td>
                            <td>Em andamento</td>
                            <td style={{ 'text-align': 'center' }}>
                                ...
                                <a href="/partidas" class="btn btn-sm btn-outline-primary" title="Partidas">
